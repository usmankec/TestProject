...
public class DriverConfig {
    ...
    /*public void initialize(ITestContext theTestContext) throws Exception{
		String theBrowserType = System.getProperty(FrameworkCommonConstants.KEY_BROWSER_TYPE);
		
		String theOSType = System.getProperty(FrameworkCommonConstants.KEY_OS_TYPE);
		
		if (theBrowserType==null) {
			theBrowserType = theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_BROWSER_TYPE);
		}
		if (theOSType==null) {
			theOSType = theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_OS_TYPE);
		}
		if (theCourseOfferingId == null) {
			theCourseOfferingId = theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_COURSE_OFFERING_ID);
		}
		
		
		Map<String, String> theSetUpInfo = new HashMap<String, String>();
		theSetUpInfo.put(FrameworkCommonConstants.KEY_TEST_ENVIRONMENT, theTestEnv);
		theSetUpInfo.put(FrameworkCommonConstants.KEY_BROWSER_TYPE, theBrowserType);
		theSetUpInfo.put(FrameworkCommonConstants.KEY_OS_TYPE, theOSType);*/
		/*theSetUpInfo.put(FrameworkCommonConstants.KEY_TENANT_ID, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_TENANT_ID));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_IS_FIREBUG_ENABLE, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_IS_FIREBUG_ENABLE));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_IS_FIREFOX_PROFILE_ENABLE, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_IS_FIREFOX_PROFILE_ENABLE));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_FIREFOX_PROFILE, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_FIREFOX_PROFILE));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_SELENIUM_HOST, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_SELENIUM_HOST));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_SELENIUM_PORT, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_SELENIUM_PORT));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_IS_RUN_ON_REMOTE, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_IS_RUN_ON_REMOTE));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_MAX_TIME_OUT, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_MAX_TIME_OUT));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_IS_BROWSER_MOB_ENABLED, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_IS_BROWSER_MOB_ENABLED));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_COURSE_OFFERING_ID, theCourseOfferingId);
		theSetUpInfo.put(FrameworkCommonConstants.KEY_RETRY_COUNT, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_RETRY_COUNT));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_EXPORT_FOLDER, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_EXPORT_FOLDER));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_COURSE_CODE, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_COURSE_CODE));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_IS_ADA_ENABLE, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_IS_ADA_ENABLE));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_BROWSER_STACK_USER, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_BROWSER_STACK_USER));
		theSetUpInfo.put(FrameworkCommonConstants.KEY_BROWSER_STACK_KEY, theTestContext.getCurrentXmlTest().getParameter(FrameworkCommonConstants.KEY_BROWSER_STACK_KEY));
		*/
