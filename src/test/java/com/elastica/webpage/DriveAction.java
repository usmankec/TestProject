...
import com.elastica.webpage.DriveLoginUILocators.DriveType;
...
public class DriveAction extends BasePage implements UiLocators, UiLocatorsDriveOperations {
	...
	public static FileType fileType;
	 ...
	 public void clickManageLink(){
		 System.out.println(manageLink.getElement());
	 ...
	 public void clickCreateLink(){
		 System.out.println(createLink.getElement());
	 ...
	 public void clickCreateFolderLink(){
		 System.out.println(createFolderLink.getElement());
	 ...
	 public void typeInNewlyCreatedFile(String content){
		 System.out.println(createTextFileLink.getElement());
		 System.out.println(createTextFileLink.isDisplayed());
	 ...
	 public void clickCreateFolderButton(){
		 System.out.println(createFolderButton.getElement());
	 ...
	 public void clickDeleteLink(){
		 System.out.println(delete.getElement());
